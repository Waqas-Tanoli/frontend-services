...
export const TrustedBySection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="careers"
      className="py-20 md:py-32 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 relative overflow-hidden"
    >
      {/* Enhanced Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 w-1 h-1 bg-blue-500 rounded-full opacity-20 animate-pulse"></div>
        <div
          className="absolute top-20 right-20 w-2 h-2 bg-purple-500 rounded-full opacity-15 animate-pulse"
          style={{ animationDelay: '1s' }}
        ></div>
        <div
          className="absolute bottom-20 left-20 w-1 h-1 bg-cyan-500 rounded-full opacity-25 animate-pulse"
            ...
            >
              <motion.a
                ...
                className={`block relative rounded-2xl md:rounded-3xl border border-gray-200/60 bg-white/70 backdrop-blur-md p-6 md:p-8 transition-all duration-500 ${
                  !isMobile ?
                    'hover:shadow-2xl hover:border-gray-300/80'
                  : 'active:scale-95'
                } overflow-hidden ${
