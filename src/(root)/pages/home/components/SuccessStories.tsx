...
import { ArrowUpRight, Zap, FileText, Users, Clock, CheckCircle, Sparkles, ArrowRight } from 'lucide-react';
...
export const SuccessStories = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-gray-50/50 " id='solutions'>
...
>
  From Chaos to Clarity
            ...
            >
              Watch messy, unstructured data transform into organized intelligence through our AI engine
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative z-10">
              {transformationSteps.map((step, index) => (
                ...
                >
                  {/* Step Card */}
                  <div className={`relative rounded-3xl border border-gray-200/80 bg-white/80 backdrop-blur-sm p-8 text-center transition-all duration-500 hover:shadow-2xl hover:scale-105 ${
                    ...
                    <div className="relative z-10">
                      {/* Icon */}
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} mb-6 text-2xl`}>
                        {step.icon}
                      </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p 
                ...
                style={{ fontFamily: 'Space Grotesk, sans-serif' }}
              >
                AI automatically categorizes and organizes your data into actionable insights
              </p>
            </div>
